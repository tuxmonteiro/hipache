...
var pidFile = function(self, path) {
    fs.writeFileSync(path, process.pid);
    util.log('Master process pid is ' + process.pid);
}
...
function Master(config) {
    ...
    pidFile = pidFile(this, config.server.pidFile);
    this.spawnWorkers(config.server.workers, config);
}

Master.prototype = new events.EventEmitter();

Master.prototype.spawnWorkers = function (number, config) {
